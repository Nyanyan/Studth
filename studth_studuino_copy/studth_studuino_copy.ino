...
const int offset_0 = -15;
const int offset_1 = -15;

const int grb[2] = {105+offset_0, 105+offset_1};
const int rls[2] = {80+offset_0, 80+offset_1};
const int rls_big[2] = {40+offset_0, 40+offset_1};
